...
class NetworkWeights:
    ...
    def __init__(self, X, y, node_list, activation, bias=True,
        ...
        self.X = X
        self.y_true = y
        self.X_train, self.X_val, self.y_train, self.y_val = train_test_split(self.X, self.y_true, test_size=0.1, random_state=0)
    ...
    def _evalHelper(self, state, X, y_true):
        self.inputs_list = []
        ...
        fitness = self.loss(y_true, y_pred)
        return fitness
    ...
    def evaluate(self, state):
        ...
        return self._evalHelper(state, self.X_train, self.y_train)
    ...
    def evaluateFitnessValidation(self, state):
        return self._evalHelper(state, self.X_val, self.y_val)
    ...
    def fit(self, X, y, init_weights=None):
        ...
        if self.algorithm == 'random_hill_climb':
            ...
            fitted_weights, loss = random_hill_climb(
                ...
                restarts=30, init_state=init_weights)
