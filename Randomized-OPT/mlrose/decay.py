...
class GeomDecay:
    ...
    * :math:`T_{min}` is the minimum temperature value.
    ...
    def __init__(self, init_temp=1.0, decay=0.999, min_temp=0.001):
...
class ArithDecay:
    ...
    * :math:`T_{min}` is the minimum temperature value.
    ...
    def __init__(self, init_temp=1.0, decay=0.001, min_temp=0.001):
...
class ExpDecay:
    ...
    * :math:`T_{min}` is the minimum temperature value.
    ...
    def __init__(self, init_temp=1.0, exp_const=0.001, min_temp=0.001):
